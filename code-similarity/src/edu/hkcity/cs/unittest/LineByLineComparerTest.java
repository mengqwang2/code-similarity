...
public class LineByLineComparerTest {
	...
	@Test
	//Test compare func by single line inputs(matched)
	public void testCompare_simple_case1() {
		String tar = "abc";
		String ori = "abc";
	...
	@Test
	//Test compare func by single line inputs(not matched)
	public void testCompare_simple_case2() {
		String tar = "abc";
		String ori = "abcd";
		comp = new LineByLineComparar(tar, ori);
		String result = comp.compare(new Formatter(), new Output());
	...
	@Test
	//Test compare func by 2 line inputs(1 matched,1 not matched)
	public void testCompare_simple_case3() {
		String tar = "a\nb";
		String ori = "a\nc";
		comp = new LineByLineComparar(tar, ori);
		String result = comp.compare(new Formatter(), new Output());
	...
	public void testCompare_complex_case1() {
	...
	public void testCompare_complex_case2() {
	...
	public void testCompare_complex_case3() {
	...
	public void testCompare_complex_case4() {
		String tar = "#include<iostream>\nusing namespace std;\nint x,y;\nint main(){\nwhile(cin>>x>>y)\n    cout<<x+y;\ncout<<endl;\n}\n";
		String ori = "#include<iostream>\nusing namespace std;\nint main(){\nint x,y;\nwhile(cin>>x)\n{    cin>>y;\n    cout<<x+y<<endl;\n}\n}\n";
		comp = new LineByLineComparar(tar, ori);
		String result = comp.compare(new Formatter(), new Output());
